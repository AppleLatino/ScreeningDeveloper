...
@interface CalendarViewController (SWIFT_EXTENSION(ScreeningDeveloper))
@end
...
@interface CalendarViewController (SWIFT_EXTENSION(ScreeningDeveloper)) <UITableViewDelegate, UIScrollViewDelegate, UITableViewDataSource>
...
@interface UserListMessageVC (SWIFT_EXTENSION(ScreeningDeveloper)) <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
